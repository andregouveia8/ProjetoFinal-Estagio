...
var ShellContainer = (function (_super) {
    ...
    ShellContainer.prototype.render = function () {
        var _this = this;
        var className = Chat_1.classList('bg-wp-console', this.props.inputText.length > 0 && 'has-text', this.props.showUploadButton && 'has-upload-button');
        ...
        var sendButtonClassName = Chat_1.classList('bg-wp-send', showMicButton && 'hidden');
        var micButtonClassName = Chat_1.classList('bg-wp-mic', !showMicButton && 'hidden', this.props.listeningState === Store_1.ListeningState.STARTED && 'active', this.props.listeningState !== Store_1.ListeningState.STARTED && 'inactive');
        ...
        return (React.createElement("div", { className: className },
                React.createElement("input", { id: "bg-wp-upload-input", tabIndex: -1, type: "file", ref: function (input) { return _this.fileInput = input; }, multiple: true, onChange: function () { return _this.onChangeFile(); }, "aria-label": this.props.strings.uploadFile, role: "button" }),
            React.createElement("div", { className: "bg-wp-textbox" },
                React.createElement("input", { type: "text", className: "bg-wp-shellinput", ref: function (input) { return _this.textInput = input; }, autoFocus: true, value: this.props.inputText, onChange: function (_) { return _this.props.onChangeText(_this.textInput.value); }, onKeyPress: function (e) { return _this.onKeyPress(e); }, onFocus: function () { return _this.onTextInputFocus(); }, placeholder: placeholder, "aria-label": this.props.inputText ? null : placeholder, "aria-live": "polite" })),
