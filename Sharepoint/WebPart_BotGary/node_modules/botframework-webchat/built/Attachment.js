...
var Unknown = function (props) {
    if (regExpCard.test(props.contentType)) {
        ...
        return React.createElement("div", null,
            React.createElement("a", { className: "bg-wp-link-download", href: props.contentUrl, target: "_blank", title: props.contentUrl },
                React.createElement("div", { className: "bg-wp-text-download" }, props.name || props.format.strings.unknownFile.replace('%1', props.contentType)),
                React.createElement("div", { className: "bg-wp-icon-download" })));
    }
    else {
