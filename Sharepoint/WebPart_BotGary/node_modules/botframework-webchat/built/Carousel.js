...
var Carousel = (function (_super) {
    ...
    Carousel.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "bg-wp-carousel", ref: function (div) { return _this.root = div; } },
...
var CarouselAttachments = (function (_super) {
    ...
    CarouselAttachments.prototype.render = function () {
        ...
        return (React.createElement("ul", null, this.props.attachments.map(function (attachment, index) {
            return React.createElement("li", { key: index, className: "bg-wp-carousel-item" },
