...
var Chat = (function (_super) {
    ...
    Chat.prototype.render = function () {
        ...
        return (React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement("div", { className: "bg-wp-chatview-panel", onKeyDownCapture: this._handleKeyDownCapture, ref: this._saveChatviewPanelRef },
                !!state.format.chatTitle &&
                    React.createElement("div", { className: "bg-wp-header" },
