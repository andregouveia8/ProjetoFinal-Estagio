...
var MessagePaneView = function (props) {
    return React.createElement("div", { className: Chat_1.classList('bg-wp-message-pane', props.activityWithSuggestedActions && 'show-actions') },
        props.children,
        React.createElement("div", { className: "bg-wp-suggested-actions" },
