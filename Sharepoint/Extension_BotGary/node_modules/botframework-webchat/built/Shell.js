...
var ShellContainer = (function (_super) {
    ...
    ShellContainer.prototype.render = function () {
        var _this = this;
        var className = Chat_1.classList('bg-console', this.props.inputText.length > 0 && 'has-text', this.props.showUploadButton && 'has-upload-button');
        ...
        var sendButtonClassName = Chat_1.classList('bg-send', showMicButton && 'hidden');
        var micButtonClassName = Chat_1.classList('bg-mic', !showMicButton && 'hidden', this.props.listeningState === Store_1.ListeningState.STARTED && 'active', this.props.listeningState !== Store_1.ListeningState.STARTED && 'inactive');
...
exports.Shell = react_redux_1.connect(function (state) {
    return ({
