...
var HistoryView = (function (_super) {
    ...
    HistoryView.prototype.render = function () {
        ...
        var groupsClassName = Chat_1.classList('bg-message-groups', !this.props.format.chatTitle && 'no-header');
        return (React.createElement("div", { className: groupsClassName, ref: function (div) { return _this.scrollMe = div || _this.scrollMe; }, role: "log", tabIndex: 0 },
            React.createElement("div", { className: "bg-message-group-content", ref: function (div) { if (div)
...
var WrappedActivity = (function (_super) {
    ...
    WrappedActivity.prototype.render = function () {
        ...
        var wrapperClassName = Chat_1.classList('bg-message-wrapper', this.props.activity.attachmentLayout || 'list', this.props.onClickActivity && 'clickable');
        var contentClassName = Chat_1.classList('bg-message-content', this.props.selected && 'selected');
        return (React.createElement("div", { "data-activity-id": this.props.activity.id, className: wrapperClassName, onClick: this.props.onClickActivity },
            React.createElement("div", { className: 'bg-message bg-message-from-' + who, ref: function (div) { return _this.messageDiv = div; } },
                React.createElement("div", { className: contentClassName },
                    React.createElement("svg", { className: "bg-message-callout" },
                    ...
                    this.props.children)),
            React.createElement("div", { className: 'bg-message-from bg-message-from-' + who }, timeLine)));
    };
