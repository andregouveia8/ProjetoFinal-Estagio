...
var HScroll = (function (_super) {
    ...
    HScroll.prototype.scrollBy = function (direction) {
        var _this = this;
        var easingClassName = 'bg-animate-scroll';
        //cancel existing animation when clicking fast
        if (this.animateDiv) {
            easingClassName = 'bg-animate-scroll-rapid';
        ...
        if (Math.abs(dest - scrollLeft) < 60) {
            easingClassName = 'bg-animate-scroll-near';
        }
    ...
    HScroll.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "bg-hscroll-outer" },
                React.createElement("div", { className: "bg-hscroll", ref: function (div) { return _this.scrollDiv = div; } }, this.props.children)),
